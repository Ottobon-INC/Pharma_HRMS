-- ====================================================================
-- PHARMA HRMS (ORCA LABS) - COMPLETE TURNKEY DATABASE MIGRATION
-- Schema: 16 Core Tables matching Supabase Dashboard standard:
-- 1.  pharma_hrms_attendance
-- 2.  pharma_hrms_breaks
-- 3.  pharma_hrms_chat_channels
-- 4.  pharma_hrms_chat_messages
-- 5.  pharma_hrms_doctor_list_submissions
-- 6.  pharma_hrms_duty_roster
-- 7.  pharma_hrms_employees
-- 8.  pharma_hrms_field_sessions
-- 9.  pharma_hrms_field_visit_events
-- 10. pharma_hrms_field_visit_proofs
-- 11. pharma_hrms_field_visits
-- 12. pharma_hrms_invoices
-- 13. pharma_hrms_leave_balances
-- 14. pharma_hrms_leave_requests
-- 15. pharma_hrms_location_pins
-- 16. pharma_hrms_missed_punches
-- + Seeding for 35 Pharma Roster Employees (2 Admins, 1 GM, 2 ZSMs, 7 RSMs, 23 BEs)
-- ====================================================================
...
-- Ensure all columns exist even if pharma_hrms_employees pre-existed in Supabase
...
-- Drop any strict NOT NULL constraints on joining_date & basic_pay for legacy tables
...
-- Update employee_code to id if null
UPDATE "pharma_hrms_employees" SET "employee_code" = "id" WHERE "employee_code" IS NULL;

-- Remove legacy constraints on role or hierarchy_level if they conflict
...
-- 6. DOCTOR LIST SUBMISSIONS (EMPLOYEE SELF-SERVICE DOCTOR POOL)
...
-- Ensure all pharma columns exist on pharma_hrms_field_visits
...
-- Drop legacy check constraints on leave_type so pharma 'privilege' / 'casual' are accepted
...
-- ====================================================================
-- ROW LEVEL SECURITY (PERMISSIVE ACCESS FOR CLIENT HRMS)
-- ====================================================================
DO $$ 
DECLARE
  tbl text;
...
-- ====================================================================
-- SEED EMPLOYEES ROSTER (35 PERSONNEL ACCORDING TO PRIMARY SPREADSHEET & DIAGRAM)
-- 2 Admins (GM & HR/Fin), 2 ZSMs (TS/AP), 7 RSMs, 24 BEs
...
-- 2. Zonal Sales Managers (ZSM) - reporting directly to GM P Aswani (OL026)
...
-- ====================================================================
-- SEED INITIAL LEAVE BALANCES FOR ALL 35 EMPLOYEES
-- ====================================================================
DO $$
BEGIN
